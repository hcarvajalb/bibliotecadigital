...
<link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous"/>
    ...
    <xsl:template name="buildHeader">
        ...
        <header>
            <div class="navbar navbar-default navbar-static-top" role="navigation" style="height: 150px;">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="{$context-path}/" class="navbar-brand">
                            <img style="float: left; margin-right: 10px;" alt="Prodigio Consultores" src="{$theme-path}images/logo-segpres.svg" />
							<h1 id="titulo" style="color: #333; max-width: 491px;">Biblioteca Digital del Gobierno de Chile</h1>
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 col-sm-4 hidden-print">
                        <div class="pull-right">
                            <a title="Demo DSpace" href="/">
                                <img style="max-width: 112px;" alt="Prodigio Consultores" src="{$theme-path}images/logo-segpres.png"/>								
                            </a>
                        </div>
