...
<!--            <div class="artifact-info">
            ...
            <xsl:call-template name="itemSummaryView-DIM-entity"/>
            <xsl:call-template name="itemSummaryView-DIM-specific"/>
        ...
        <xsl:param name="href"/>
            ...
            <a href="{$href}">
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <img class="media-object" alt="xmlui.mirage2.item-list.thumbnail" i18n:attr="alt" src="{$theme-path}images/mime.png"/>
                    </xsl:otherwise>
                </xsl:choose>
            </a>
    ...
    <xsl:template name="itemSummaryView-DIM-entity">
    ...
    <xsl:template name="itemSummaryView-DIM-specific">
